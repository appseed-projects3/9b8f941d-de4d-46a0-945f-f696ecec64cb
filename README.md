...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-11-12 23:57`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/9b8f941d-de4d-46a0-945f-f696ecec64cb.git
$ cd 9b8f941d-de4d-46a0-945f-f696ecec64cb
```
